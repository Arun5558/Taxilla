package com.selenium.DataDriven.Mail;
...
public class ZipAndSendMail
{
	...
	static String[] toEmails = { "aknandigam@taxilla.com"};
	static String fromUser = "n.arunkumar6@gmail.com";// imap on, other devices on, no recovery phone
	static String password = "Zebronic@1";
